<template class="bg-dark text-light pb-5">
  <div v-if="!not" class="bg-dark text-light pb-5 body">
    ...
    <div class="text-center position-fixed d-flex mt-2"
      style="background-color: #21252900; gap: calc((100vw - clamp(20px, 6vw, 25px)) / 6);width:70vw;z-index: 100;top: -6px;left:50%;transform: translateX(-50%);display: flex;justify-content: center;align-items: center;">
      <a @click="image" class="" style="right: 50px;left: auto"><svg xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
      ...
      <a @click="pined" class="" style="right: 0px;left: auto"><svg xmlns="http://www.w3.org/2000/svg"
